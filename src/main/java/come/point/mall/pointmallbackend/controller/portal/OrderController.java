...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse create(HttpSession session, Integer addressId, List<OrderProductVo> products) {
        User user = (User)session.getAttribute(Const.CURRENT_USER);
        if(user == null) {
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(),ResponseCode.NEED_LOGIN.getDesc());
        }
        return orderService.createOrder(user.getId(),addressId,products);
    }
    ...
    @ResponseBody
    public ServerResponse updateStatus(Integer orderId,Integer status) {
